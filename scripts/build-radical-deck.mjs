...
/** Seconds of audio in a file, per `afinfo`; 0 when it cannot tell. */
function clipSeconds(path) {
 ...
 * the deck's clips are and what every client, desktop and mobile, plays.
 */
function fromSay(text, destBase) {
