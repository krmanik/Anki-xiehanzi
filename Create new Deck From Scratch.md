...
https://github.com/krmanik/Anki-xiehanzi/blob/master/frontcard
#### back side of card - add this to back of card
https://github.com/krmanik/Anki-xiehanzi/blob/master/backcard
...
# Sample 2 Implementation
  ...
  #### 1. Download [Xiehanzi Sample](https://github.com/krmanik/Anki-xiehanzi/blob/master/HSK%20Anki%20apkg/Xiehanzi%20Sample.apkg?raw=true)
  
![Demo2](https://github.com/krmanik/Anki-xiehanzi/blob/master/image/Create_from_scratch_demo_2.gif?raw=true)

# Sample 2 Codes
#### front side of card - add this front of the card
https://github.com/krmanik/Anki-xiehanzi/blob/master/version%201.1/frontcard_1.1.html
#### back side of card - add this to back of card
https://github.com/krmanik/Anki-xiehanzi/blob/master/version%201.1/backcard_1.1.html
#### css of card - add this to css of card
https://github.com/krmanik/Anki-xiehanzi/blob/master/version%201.1/cardCSS_1.1.css

#### Five fields used in the [xiehanzi sample deck](https://github.com/krmanik/Anki-xiehanzi/blob/master/HSK%20Anki%20apkg/Xiehanzi%20Sample.apkg?raw=true)
##### {{Simplified}}
##### {{Traditional}}
##### {{Pinyin}}
##### {{Audio}}
...
Author : Mani (krmanik)
<br>The MIT License
<br>[License](https://github.com/krmanik/Anki-xiehanzi/blob/master/License.md)
