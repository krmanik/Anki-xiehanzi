...
export const CARD_THEMES: CardTheme[] = [
	...
	// Flat sections split by hairlines; underlined dominant POS; outline badges.
	{
		...
		cssVars: {
			...
			'--pos-chip-bg': '#f1f1f5', '--pos-chip-border': '1px solid #e2e2e9', '--pos-chip-fg': '#6e6e78',
			'--pos-chip-pad': '5px 11px',
			'--chip-bg': 'var(--accent)', '--chip-fg': 'var(--on-accent)',
			'--pos-dominant-underline': 'none',
			'--hsk-bg': 'color-mix(in srgb,var(--accent) 12%,transparent)', '--hsk-fg': '#3a6df0', '--hsk-border': 'color-mix(in srgb,var(--accent) 32%,transparent)',
			'--freq-bg': '#fdf2e0', '--freq-fg': '#d98a16', '--freq-border': '#f1ddb2',
	...
	},
	{
		...
		cssVars: {
			...
			'--radical-chip-radius': '10px', '--radical-rad-color': 'var(--accent)',
			'--pos-chip-bg': '#202027', '--pos-chip-border': '1px solid #303039', '--pos-chip-fg': '#9a9aa4',
			'--pos-chip-pad': '5px 11px',
			'--chip-bg': 'var(--accent)', '--chip-fg': 'var(--on-accent)',
			'--pos-dominant-underline': 'none',
			'--hsk-bg': 'color-mix(in srgb,var(--accent) 16%,transparent)', '--hsk-fg': '#6f9bff', '--hsk-border': 'color-mix(in srgb,var(--accent) 40%,transparent)',
			'--freq-bg': 'rgba(240,169,58,.13)', '--freq-fg': '#e0a94e', '--freq-border': 'rgba(240,169,58,.32)',
			'--example-item-bg': 'transparent', '--example-item-border': 'none', '--example-item-left': 'none',
	...
	// Flat parchment sections; filled HSK seal-chip; round paper buttons.
	{
		...
		cssVars: {
			...
			'--pos-chip-bg': '#ece0c8', '--pos-chip-border': '1px solid #d4c298', '--pos-chip-fg': '#8a7a54',
			'--pos-chip-pad': '5px 11px',
			'--chip-bg': 'var(--accent)', '--chip-fg': '#fdf3ea',
			'--pos-dominant-underline': 'none',
			'--hsk-bg': 'var(--accent)', '--hsk-fg': '#fdf3ea', '--hsk-border': '#8f2a22',
			'--freq-bg': '#e9dcbf', '--freq-fg': '#9a6e1e', '--freq-border': '#cdb98f',
			'--example-item-bg': 'transparent', '--example-item-border': 'none', '--example-item-left': 'none',
	...
	},
	{
		...
		cssVars: {
			...
			'--radical-chip-radius': '6px', '--radical-rad-color': 'var(--accent)',
			'--pos-chip-bg': '#2b2417', '--pos-chip-border': '1px solid #5a4d33', '--pos-chip-fg': '#a8966c',
			'--pos-chip-pad': '5px 11px',
			'--chip-bg': 'var(--accent)', '--chip-fg': '#1a1712',
			'--pos-dominant-underline': 'none',
			'--hsk-bg': 'var(--accent)', '--hsk-fg': '#1a1712', '--hsk-border': '#b54f3d',
			'--freq-bg': 'rgba(224,178,90,.14)', '--freq-fg': '#d8b46a', '--freq-border': 'rgba(224,178,90,.34)',
			'--example-item-bg': 'transparent', '--example-item-border': 'none', '--example-item-left': 'none',
	...
	// Flat hairline sections; outline POS pills with a filled violet dominant.
	{
		...
		cssVars: {
			...
			'--radical-chip-radius': '10px', '--radical-rad-color': 'var(--accent)',
			'--pos-chip-bg': '#14141d', '--pos-chip-border': '1px solid #2a2a34', '--pos-chip-fg': '#9a9aa8',
			'--pos-chip-pad': '5px 11px',
			'--chip-bg': 'var(--accent)', '--chip-fg': '#0a0a0c',
			'--pos-dominant-underline': 'none',
			'--hsk-bg': 'color-mix(in srgb,var(--accent) 18%,transparent)', '--hsk-fg': '#bfa8ff', '--hsk-border': 'color-mix(in srgb,var(--accent) 42%,transparent)',
			'--freq-bg': 'rgba(240,169,58,.14)', '--freq-fg': '#e8b362', '--freq-border': 'rgba(240,169,58,.34)',
			'--example-item-bg': 'transparent', '--example-item-border': 'none', '--example-item-left': 'none',
	...
	// ── 03b OLED Light ───────────────────────────────────────────────────────
	{
		...
		cssVars: {
			...
			'--radical-chip-radius': '10px', '--radical-rad-color': 'var(--accent)',
			'--pos-chip-bg': '#f4f1fd', '--pos-chip-border': '1px solid #e4ddf7', '--pos-chip-fg': '#8a82a0',
			'--pos-chip-pad': '5px 11px',
			'--chip-bg': 'var(--accent)', '--chip-fg': '#ffffff',
			'--pos-dominant-underline': 'none',
			'--hsk-bg': 'color-mix(in srgb,var(--accent) 12%,transparent)', '--hsk-fg': '#7c5cf0', '--hsk-border': 'color-mix(in srgb,var(--accent) 32%,transparent)',
			'--freq-bg': '#fdf2e0', '--freq-fg': '#d98a16', '--freq-border': '#f1ddb2',
			'--example-item-bg': 'transparent', '--example-item-border': 'none', '--example-item-left': 'none',
	...
	// Boxed soft panels (no title bar fill); candy badges; lavender radical row.
	{
		...
		cssVars: {
			...
			'--pos-chip-bg': '#eef0ff', '--pos-chip-border': '1px solid #d8dbf6', '--pos-chip-fg': '#9b8ed6',
			'--pos-chip-pad': '5px 11px',
			'--chip-bg': 'var(--accent)', '--chip-fg': '#ffffff',
			'--pos-dominant-underline': 'none',
			'--hsk-bg': '#62c79e', '--hsk-fg': '#ffffff', '--hsk-border': '#4cae88',
			'--freq-bg': '#fff1cc', '--freq-fg': '#d99a1e', '--freq-border': '#f0dca0',
	...
	},
	{
		...
		cssVars: {
			...
			'--pos-chip-bg': 'rgba(157,139,196,.2)', '--pos-chip-border': '1px solid rgba(157,139,196,.4)', '--pos-chip-fg': '#c3b3e8',
			'--pos-chip-pad': '5px 11px',
			'--chip-bg': 'var(--accent)', '--chip-fg': '#2a1f3d',
			'--pos-dominant-underline': 'none',
			'--hsk-bg': '#7fe7c0', '--hsk-fg': '#1c2438', '--hsk-border': '#5fcfa6',
			'--freq-bg': 'rgba(255,209,102,.16)', '--freq-fg': '#ffd166', '--freq-border': 'rgba(255,209,102,.4)',
	...
	// Flat keyline sections: red tracked titles ruled below, mono ghost numbers.
	{
		...
		cssVars: {
			...
			'--pos-chip-bg': '#e7e1d4', '--pos-chip-border': '1px solid #cfc7b5', '--pos-chip-fg': '#6e675a',
			'--pos-chip-pad': '5px 11px', '--pos-chip-transform': 'uppercase',
			'--chip-bg': '#16140f', '--chip-fg': '#f6f3ec', '--chip-border': '1px solid #16140f',
			'--pos-dominant-underline': 'none',
			'--hsk-bg': 'transparent', '--hsk-fg': '#d6402a', '--hsk-border': '#d6402a',
			'--freq-bg': 'transparent', '--freq-fg': '#16140f', '--freq-border': '#16140f',
	...
	},
	{
		...
		cssVars: {
			...
			'--pos-chip-bg': '#211c15', '--pos-chip-border': '1px solid #3a3329', '--pos-chip-fg': '#b3aa98',
			'--pos-chip-pad': '5px 11px', '--pos-chip-transform': 'uppercase',
			'--chip-bg': '#f0ebe0', '--chip-fg': '#15120e', '--chip-border': '1px solid #f0ebe0',
			'--pos-dominant-underline': 'none',
			'--hsk-bg': 'transparent', '--hsk-fg': '#ef6a4d', '--hsk-border': '#ef6a4d',
			'--freq-bg': 'transparent', '--freq-fg': '#f0ebe0', '--freq-border': '#5a5346',
	...
	// Boxed panels with tinted header bars — the reference for the default look.
	{
		...
		cssVars: {
			...
			'--radical-chip-radius': '10px', '--radical-rad-color': 'var(--accent)',
			'--pos-chip-bg': '#f1f3f7', '--pos-chip-border': '1px solid #e1e5ec', '--pos-chip-fg': '#6b7280',
			'--pos-chip-pad': '5px 11px',
			'--chip-bg': '#1f2937', '--chip-fg': '#ffffff',
			'--pos-dominant-underline': 'none',
			'--hsk-bg': '#e8f0ff', '--hsk-fg': '#2f6bff', '--hsk-border': '#cbdcff',
			'--freq-bg': '#fdf2e0', '--freq-fg': '#d9820e', '--freq-border': '#f3ddb2',
			'--example-item-bg': 'transparent', '--example-item-border': 'none', '--example-item-left': 'none',
	...
	},
	{
		...
		cssVars: {
			...
			'--radical-chip-radius': '10px', '--radical-rad-color': 'var(--accent)',
			'--pos-chip-bg': '#23262f', '--pos-chip-border': '1px solid #31353f', '--pos-chip-fg': '#9aa1b2',
			'--pos-chip-pad': '5px 11px',
			'--chip-bg': '#e6e9f0', '--chip-fg': '#0f1115',
			'--pos-dominant-underline': 'none',
			'--hsk-bg': 'rgba(61,123,255,.16)', '--hsk-fg': '#5d93ff', '--hsk-border': 'rgba(61,123,255,.4)',
			'--freq-bg': 'rgba(240,169,58,.16)', '--freq-fg': '#f0a93a', '--freq-border': 'rgba(240,169,58,.4)',
			'--example-item-bg': 'transparent', '--example-item-border': 'none', '--example-item-left': 'none',
	...
	// Thick ruled titles, numbered yellow squares, color-bar examples, boxed radical.
	{
		...
		cssVars: {
			...
			'--pos-chip-bg': '#fffced', '--pos-chip-border': '2px solid #121212', '--pos-chip-fg': '#121212',
			'--pos-chip-pad': '5px 11px', '--pos-chip-transform': 'uppercase',
			'--chip-bg': '#ffe600', '--chip-fg': '#121212', '--chip-border': '2px solid #121212',
			'--pos-dominant-underline': 'none',
			'--hsk-bg': '#ff3b3b', '--hsk-fg': '#ffffff', '--hsk-border': '#121212',
			'--freq-bg': '#2962ff', '--freq-fg': '#ffffff', '--freq-border': '#121212',
	...
	},
	{
		...
		cssVars: {
			...
			'--pos-chip-bg': '#0c0c0c', '--pos-chip-border': '2px solid #f4f4ec', '--pos-chip-fg': '#f4f4ec',
			'--pos-chip-pad': '5px 11px', '--pos-chip-transform': 'uppercase',
			'--chip-bg': '#c6ff3a', '--chip-fg': '#141414', '--chip-border': '2px solid #f4f4ec',
			'--pos-dominant-underline': 'none',
			'--hsk-bg': '#ff3b6b', '--hsk-fg': '#ffffff', '--hsk-border': '#f4f4ec',
			'--freq-bg': '#00e5ff', '--freq-fg': '#141414', '--freq-border': '#f4f4ec',
	...
	// Flat ruled senses, plain-text badges, left-bar citations.
	{
		...
		cssVars: {
			...
			'--pos-chip-bg': '#ece2c8', '--pos-chip-border': '1px solid #c9bb90', '--pos-chip-fg': '#6f6444',
			'--pos-chip-pad': '5px 11px',
			'--chip-bg': 'var(--accent)', '--chip-fg': '#f3ecd9',
			'--pos-dominant-underline': 'none',
			'--hsk-bg': 'color-mix(in srgb,var(--accent) 14%,transparent)', '--hsk-fg': '#2c5f56', '--hsk-border': 'color-mix(in srgb,var(--accent) 38%,transparent)',
			'--freq-bg': '#ebe0c2', '--freq-fg': '#8a6a28', '--freq-border': '#cdbb8c',
	...
	},
	{
		...
		cssVars: {
			...
			'--radical-chip-bg': 'transparent', '--radical-chip-border': 'none',
			'--radical-chip-radius': '2px', '--radical-rad-color': 'var(--accent)',
			'--pos-chip-bg': '#2a2114', '--pos-chip-border': '1px solid #6a572f', '--pos-chip-fg': '#c2a86e',
			'--pos-chip-pad': '5px 11px',
			'--chip-bg': 'var(--accent)', '--chip-fg': '#1b1610',
			'--pos-dominant-underline': 'none',
			'--hsk-bg': 'color-mix(in srgb,var(--accent) 16%,transparent)', '--hsk-fg': '#6fc7b4', '--hsk-border': 'color-mix(in srgb,var(--accent) 40%,transparent)',
			'--freq-bg': 'rgba(224,178,90,.14)', '--freq-fg': '#d8b46a', '--freq-border': 'rgba(224,178,90,.34)',
	...
	// Glass card over an aurora body; flat translucent sections inside.
	{
		...
		cssVars: {
			...
			'--radical-chip-radius': '10px', '--radical-rad-color': 'var(--accent)',
			'--pos-chip-bg': 'rgba(255,255,255,0.14)', '--pos-chip-border': '1px solid rgba(255,255,255,0.28)', '--pos-chip-fg': '#ffffff',
			'--pos-chip-pad': '5px 11px',
			'--chip-bg': 'rgba(255,255,255,0.85)', '--chip-fg': '#1b2a4a',
			'--pos-dominant-underline': 'none',
			'--hsk-bg': 'var(--accent)', '--hsk-fg': '#1b2a4a', '--hsk-border': 'rgba(168,240,255,0.6)',
			'--freq-bg': 'rgba(255,224,168,0.12)', '--freq-fg': '#ffe0a8', '--freq-border': 'rgba(255,224,168,0.4)',
			'--example-item-bg': 'transparent', '--example-item-border': 'none', '--example-item-left': 'none',
	...
	},
	{
		...
		cssVars: {
			...
			'--chip-bg': 'var(--accent)', '--chip-fg': '#ffffff',
			'--pos-dominant-underline': 'none',
			'--hsk-bg': 'var(--accent)', '--hsk-fg': '#ffffff', '--hsk-border': 'rgba(58,160,168,0.55)',
			'--freq-bg': 'rgba(255,236,200,0.7)', '--freq-fg': '#bd7a1e', '--freq-border': 'rgba(210,160,90,0.5)',
			'--example-item-bg': 'transparent', '--example-item-border': 'none', '--example-item-left': 'none',
	...
	// Flat hairline sections, ghost numbers, text-only chips, chromeless buttons.
	{
		...
		cssVars: {
			...
			'--pos-chip-bg': '#e7e1d2', '--pos-chip-border': '1px solid #d6cfba', '--pos-chip-fg': '#8c8470',
			'--pos-chip-pad': '5px 11px',
			'--chip-bg': 'var(--accent)', '--chip-fg': '#ffffff',
			'--pos-dominant-underline': 'none',
			'--hsk-bg': 'color-mix(in srgb,var(--accent) 16%,#ffffff)', '--hsk-fg': '#5f6b4c', '--hsk-border': 'color-mix(in srgb,var(--accent) 36%,transparent)',
			'--freq-bg': '#ece2cc', '--freq-fg': '#9a7b3e', '--freq-border': '#d8c9a6',
	...
	},
	{
		...
		cssVars: {
			...
			'--radical-chip-bg': 'transparent', '--radical-chip-border': 'none',
			'--radical-chip-radius': '0px', '--radical-rad-color': 'var(--accent)',
			'--pos-chip-bg': '#23211b', '--pos-chip-border': '1px solid #34322a', '--pos-chip-fg': '#8e8775',
			'--pos-chip-pad': '5px 11px',
			'--chip-bg': 'var(--accent)', '--chip-fg': '#1a1915',
			'--pos-dominant-underline': 'none',
			'--hsk-bg': 'color-mix(in srgb,var(--accent) 16%,transparent)', '--hsk-fg': '#a3b389', '--hsk-border': 'color-mix(in srgb,var(--accent) 38%,transparent)',
			'--freq-bg': 'rgba(190,160,90,.14)', '--freq-fg': '#c2a86e', '--freq-border': 'rgba(190,160,90,.34)',
			'--def-num-color': 'var(--accent)',
			'--example-item-bg': 'transparent', '--example-item-border': 'none', '--example-item-left': 'none',
